...
def generate_grouped_output(domain_to_steps, output_path):
    ...
    for domain, steps in domain_to_steps.items():
        ...
        for image_path, step_group in grouped_by_image.items():
            ...
            merged_steps.append(
                InteractionStep(
                    ...
                    all_ui_elements=unique_elements or None,
                    conversation_list=step_group[0].conversation_list,
                )
            )
        ...
        trajectory_list.append(traj.model_dump(exclude_none=True))
...
def main():
    ...
    print("AGUVIS Stage 2 parsing complete.")
